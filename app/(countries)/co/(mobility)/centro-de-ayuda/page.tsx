...
export const metadata: Metadata = {
  title:
    "Centro de Ayuda DiDi - App nº1 en movilidad del mundo | DiDi Colombia",
  description:
  ...
  alternates: {
    canonical: `https://web.didiglobal.com/co/centro-de-ayuda/`,
    languages: hreflangs.helpCenter,
  },
};

const CentroDeAyuda = async () => {
  const components = await fetchPageComponents("/co/centro-de-ayuda/");
