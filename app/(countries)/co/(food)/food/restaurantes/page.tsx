...
export const metadata: Metadata = {
  title:
    "Registra tu Tienda o Restaurante y crece con DiDi Food | DiDi Food Colombia",
  description:
  ...
  alternates: {
    canonical: `https://web.didiglobal.com/co/food/restaurantes/`,
  },
};

const page = async () => {
  const components = await fetchPageComponents("/co/food/restaurantes/");
