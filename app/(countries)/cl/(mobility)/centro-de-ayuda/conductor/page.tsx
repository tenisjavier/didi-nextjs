...
export const metadata: Metadata = {
  title:
    "Centro de Ayuda DiDi Conductor - App nº1 en movilidad del mundo | DiDi Chile",
  description:
  ...
  alternates: {
    canonical: `https://web.didiglobal.com/cl/centro-de-ayuda/conductor/`,
  },
};

const CentroDeAyuda = async () => {
  let pathname = "/cl/centro-de-ayuda/conductor/";
