...
export const metadata: Metadata = {
  title: "Preguntas Frecuentes sobre DiDi Préstamos | DiDi México",
  description:
  ...
  alternates: {
    canonical: `https://web.didiglobal.com/mx/prestamos/preguntas-frecuentes/`,
  },
};

const Page = async () => {
  const components = await fetchPageComponents(
    "/mx/prestamos/preguntas-frecuentes/"
  );
  return (
    <>
