...
export let metadata: Metadata = {
  ...
  description:
    "DiDi en Peru, registrate como socio conductor en las categorías express y taxi ganando más y manejando menos. Si sos Socio Conductor llamános al +54 (11) 3987-6342",
};
...
const Guide = async ({ params: { slug } }: GuiasProps) => {
  ...
  const suggestedGuides = await fetchGuidesByCategory("restaurant", "pe");
...
export async function generateStaticParams() {
  const guides = await fetchGuidesByCategory("restaurant", "pe");
