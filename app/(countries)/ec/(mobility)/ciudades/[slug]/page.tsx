...
export let metadata: Metadata = {
  ...
  description:
    "DiDi en Equador, registrate como socio conductor en las categorías express y taxi ganando más y manejando menos. Si sos Socio Conductor llamános al +54 (11) 3987-6342",
};

const Guide = async ({ params: { slug } }: GuiasProps) => {
  const city = await fetchCitieBySlug("ec", slug);
...
export async function generateStaticParams() {
  const cities = await fetchCities("ec", "driver")
