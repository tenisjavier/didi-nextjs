...
export let metadata: Metadata = {
  ...
  description:
    "DiDi en Colombia, registrate como socio conductor en las categorías express y taxi ganando más y manejando menos. Si sos Socio Conductor llamános al +54 (11) 3987-6342",
};
  ...
  const suggestedGuidesProps = {
    ...
    columns: suggestedArticles.map((article: ArticleT) => {
      return {
        ...
        btnMode: "dark",
        btnText: "Leer Guía",
        btnLink: `/co/food/blog/${article.slug}`,
      };
    }),
  };
  return (
