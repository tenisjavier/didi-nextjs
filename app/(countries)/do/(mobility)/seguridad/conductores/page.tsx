...
export const metadata: Metadata = {
  title: "En DiDi tu Seguridad es nuestra prioridad conoce más acá | DiDi República Dominicana",
  description:
...
const Seguridad = async () => {
  const components = await fetchPageComponents("/do/seguridad/conductores/");
